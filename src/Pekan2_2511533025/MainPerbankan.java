        ...
        do {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    Rekening rekBaru = new Rekening(no, nama, saldoAwal);
                ...
                case 5:
                    if (daftarRekening.isEmpty()) {
                        ...
                        for (int i = 0; i < daftarRekening.size(); i++) {
                            System.out.println((i + 1) + ". " + daftarRekening.get(i).namaPemilik + " (" + daftarRekening.get(i).nomorRekening + ")");
                        }
                        ...
                        if (indeks >= 0 && indeks < daftarRekening.size()) {
                            ...
                            System.out.println("Berhasil beralih ke akun " + akunAktif.namaPemilik);
                        } else {
                ...
                case 6: 
                    if (akunAktif == null) {
                        ...
                        if (akunAktif.riwayatTransaksi.isEmpty()) {
                            ...
                            for (Transaksi trx : akunAktif.riwayatTransaksi) {
