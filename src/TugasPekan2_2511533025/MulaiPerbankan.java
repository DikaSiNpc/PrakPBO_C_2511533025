...
public class MulaiPerbankan {

    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        ArrayList<SimpananBank> daftarRekening =
                new ArrayList<>();
        SimpananBank akunAktif = null;
        int pilihan;
        do {
            System.out.println(
            ...
            if (akunAktif == null) {
                ...
                System.out.println(
                        "Akun Aktif : Tidak ada akun yang dipilih"
                );
            } else {
                ...
                case 5:
                    ...
                    if (daftarRekening.isEmpty()) {
                        ...
                        if (
                            ...
                            akunAktif =
                                    daftarRekening.get(indeks);

                            System.out.println(
                                    "Berhasil beralih ke akun "
                                    + akunAktif.namaPemilik);
                        } else {
